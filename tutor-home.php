<?php
    ...
    if(strlen($_SESSION['VLearnTutorSessionCounter']) == 0) {
        ...
        //echo "<h1>Welcome to Tutor Homepage, $tutorName !</h1>"; //displays greeting message

        //echo "<a href='tutor-logout.php?logout=true'><i class='fa fa-sign-out'></i>Logout</a>"; //logout
?>
...
<head>
	...
	<title>VLearn for Tutors | My Subjects</title>
                ...
                <div class="panel panel-default">
                    <div class="panel-body easypiechart-panel">
                        ...
                        <div class="col-md-10" style="width: 100%;">
                            <!-- Table -->
                            <table id="table13" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                ...
                                <tbody>
                                    <?php
                                        $sql = "SELECT subjectName, subjectCode, subjectStage, subjectCategory, subjectSession, subjectCreationDate, subjectId FROM subjects WHERE tutorId=$tutorId ORDER BY subjectCode";
                                        $result = mysqli_query($con, $sql);
                                        if(mysqli_num_rows($result) == 0) {
                                            echo "<p class='message'>There are no assigned subjects for you.</p>"; //displays message if no records found
                                        }
                                        else {
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="tutor-topic-list.php?subjectId=<?php echo $subjectId; ?>"><button class="btn btn-primary">Go</button></a></td>
                                    </tr>
                                    <?php
                                            }
                                        }
