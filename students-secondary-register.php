        ...
        if($result > 0) {
            ...
            if(($studentStage=="Form 1" || $studentStage=="Form 2" || $studentStage=="Form 3") && (strpos($studentSubjectsCombined, "Additional_Mathematics") !== false || strpos($studentSubjectsCombined, "Biology") !== false || strpos($studentSubjectsCombined, "Chemistry") !== false || strpos($studentSubjectsCombined, "Physics") !== false)) {
                ...
                */
                ...
                //prepare and bind
                $statement = $con->prepare("INSERT INTO students(studentName, studentEmail, studentPassword, studentEducationLevel, 
                                            studentStage, studentSubjects, studentRegistrationDate)
                                            VALUES (?, ?, ?, ?, ?, ?, ?)");
                $statement->bind_param("sssssss", $studentName, $studentEmail, $studentPassword, $studentEducationLevel, 
                                        $studentStage, $studentSubjectsCombined, $studentRegistrationDate);
                ...
                $studentEducationLevel = "Secondary"; //sets as secondary
                $studentStage = $_POST['studentStage']; //retrieves form data
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-container">Form 1
                                        <input type="radio" name="studentStage" value="Form 1" checked="checked">
