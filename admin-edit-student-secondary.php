    ...
    if(strlen($_SESSION['VLearnAdminSessionCounter']) == 0) {
        ...
        if(isset($_POST['submit'])) {
            ...
            */
            ...
            if(($studentStage=="Form 1" || $studentStage=="Form 2" || $studentStage=="Form 3") && (strpos($studentSubjectsCombined, "Additional_Mathematics") !== false || strpos($studentSubjectsCombined, "Biology") !== false || strpos($studentSubjectsCombined, "Chemistry") !== false || strpos($studentSubjectsCombined, "Physics") !== false)) {
                echo "<script>alert('Additional Mathematics, Biology, Chemistry & Physics are not offered for Form 1, Form 2 & Form 3.');</script>"; //displays error message via alert box
            }
            else {
                    ...
                    <form role="form" action="" method="post" id="" name="editStudentDetailsForm" onsubmit="return validateEditStudentDetails();">
                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-container">Form 1
                                    <input type="radio" name="studentStage" value="Form 1" 
                                        <?php
                                            if($row['studentStage'] == "Form 1") {
                                ...
                                <label class="radio-container">Form 2
                                    <input type="radio" name="studentStage" value="Form 2" 
                                        <?php
                                            if($row['studentStage'] == "Form 2") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="radio-container">Form 3
                                    <input type="radio" name="studentStage" value="Form 3" 
                                        <?php
                                            if($row['studentStage'] == "Form 3") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="radio-container">Form 4
                                    <input type="radio" name="studentStage" value="Form 4" 
                                        <?php
                                            if($row['studentStage'] == "Form 4") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="radio-container">Form 5
                                    <input type="radio" name="studentStage" value="Form 5" 
                                        <?php
                                            if($row['studentStage'] == "Form 5") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                            ...
                            <div class="form-group">
                                    ...
                                    <input type="checkbox" name="studentSubjects[]" value="Mathematics" 
                                        <?php
                                            if(strpos($row['studentSubjects'], "Mathematics") !== false) {
                                                if(substr($row['studentSubjects'], 0, 11) == "Mathematics" || substr($row['studentSubjects'], 8, 11) == "Mathematics") {
                                                    echo "checked='checked'";
                                                }
                                            }
                                        ?>
                                ...
                                <label class="checkbox-container">Additional Mathematics
                                    <input type="checkbox" name="studentSubjects[]" value="Additional_Mathematics" 
                                        <?php
                                            if(strpos($row['studentSubjects'], "Additional_Mathematics") !== false) {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="checkbox-container">Biology
                                    <input type="checkbox" name="studentSubjects[]" value="Biology" 
                                        <?php
                                            if(strpos($row['studentSubjects'], "Biology") !== false) {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="checkbox-container">Chemistry
                                    <input type="checkbox" name="studentSubjects[]" value="Chemistry" 
                                        <?php
                                            if(strpos($row['studentSubjects'], "Chemistry") !== false) {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="checkbox-container">Physics
                                    <input type="checkbox" name="studentSubjects[]" value="Physics" 
                                        <?php
                                            if(strpos($row['studentSubjects'], "Physics") !== false) {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
