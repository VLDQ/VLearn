        ...
        if(isset($_POST['submit'])) {
            ...
            */
            ...
            if($result > 0) {
                ...
                if(($subjectStage=="Form 1" || $subjectStage=="Form 2" || $subjectStage=="Form 3") && ($subjectCategory=="Additional Mathematics" || $subjectCategory=="Biology" || $subjectCategory=="Chemistry" || $subjectCategory=="Physics")) {
                ...
                <div class="panel panel-default">
                    ...
                    <form role="form" action="" method="post" id="" name="editSubjectForm" onsubmit="return validateEditSubject();">
                        ...
                        <fieldset>
                            ...
                            <!-- Subject Code -->
                            <div class="form-group">
                                <p class="form-field-title">Subject Code (E.g., ENG_F1_M):</p>
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-container">Form 1
                                    <input type="radio" name="subjectStage" value="Form 1" 
                                        <?php
                                            if($row['subjectStage'] == "Form 1") {
                                ...
                                <label class="radio-container">Form 2
                                    <input type="radio" name="subjectStage" value="Form 2" 
                                        <?php
                                            if($row['subjectStage'] == "Form 2") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="radio-container">Form 3
                                    <input type="radio" name="subjectStage" value="Form 3" 
                                        <?php
                                            if($row['subjectStage'] == "Form 3") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="radio-container">Form 4
                                    <input type="radio" name="subjectStage" value="Form 4" 
                                        <?php
                                            if($row['subjectStage'] == "Form 4") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="radio-container">Form 5
                                    <input type="radio" name="subjectStage" value="Form 5" 
                                        <?php
                                            if($row['subjectStage'] == "Form 5") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-container">Additional Mathematics
                                    <input type="radio" name="subjectCategory" value="Additional Mathematics" 
                                        <?php
                                            if($row['subjectCategory'] == "Additional Mathematics") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="radio-container">Biology
                                    <input type="radio" name="subjectCategory" value="Biology" 
                                        <?php
                                            if($row['subjectCategory'] == "Biology") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="radio-container">Chemistry
                                    <input type="radio" name="subjectCategory" value="Chemistry" 
                                        <?php
                                            if($row['subjectCategory'] == "Chemistry") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
                                ...
                                <label class="radio-container">Physics
                                    <input type="radio" name="subjectCategory" value="Physics" 
                                        <?php
                                            if($row['subjectCategory'] == "Physics") {
                                                echo "checked='checked'";
                                            }
                                        ?>
                                    >
