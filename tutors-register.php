        ...
        */
        ...
        if($result > 0) {
            ...
            */
            ...
            //prepare and bind
            $statement = $con->prepare("INSERT INTO tutors(tutorName, tutorEmail, tutorPassword, 
                                        tutorSpeciality, tutorStartDate, tutorIsActive)
                                        VALUES (?, ?, ?, ?, ?, ?)");
            $statement->bind_param("ssssss", $tutorName, $tutorEmail, $tutorPassword, 
                                    $tutorSpeciality, $tutorStartDate, $tutorIsActive);
